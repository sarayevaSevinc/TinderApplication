            ...
            <div class="col-md-12 chat-header">
                <div class="row header-one text-white p-1">
                    <div class="col-md-6 name pl-2">
                        ...
                        <h6 class="ml-1 mb-0">${targetUser.getFullName()}</h6>
                    </div>
                ...
                <div class="col-md-12 chats pt-3 pl-2 pr-3 pb-3">
                    <ul class="p-0">
                        <#list messages as msg >
                            <#if msg.getSender_id() == loggedUserId>
                                <li class="send-msg float-right mb-2">
                                    <p class="pt-1 pb-1 pl-2 pr-2 m-0 rounded">
                                        ${msg.getMessage()}
                                    </p>
                                    <span class="receive-msg-time">${msg.getDateTime()}</span>
                                </li>
                            <#else>
                                <li class="receive-msg float-left mb-2">
                                    <div class="sender-img">
                                        <img src="${targetUser.getUrlPhoto()}" class="float-left">
                                    </div>
                                    <div class="receive-msg-desc float-left ml-2">
                                        <p class="bg-white m-0 pt-1 pb-1 pl-2 pr-2 rounded">
                                            ${msg.getMessage()}
                                        </p>
                                        <span class="receive-msg-time">${targetUser.getFullName()}, ${msg.getDateTime()}</span>
                                    </div>
                                </li>
                            </#if>
                        </#list>
